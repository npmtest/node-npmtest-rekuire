...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-rekuire/node_modules/rekuire/lib/helpers/scanner.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-rekuire">npmtest-rekuire (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-rekuire/node_modules/rekuire/lib/helpers/scanner.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.44% <small>(57 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-rekuire/node_modules/rekuire/lib/helpers/</a> &#187; scanner.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function scanner(){</span>}
&nbsp;
/**
**********************************
    PUBLIC METHODS
...
&nbsp;
scanner.ignore = <span class="fstat-no" title="function not covered" >function(_foldersToIgnore){</span>
<span class="cstat-no" title="statement not covered" >    foldersToIgnore = _foldersToIgnore.concat(['node_modules']);</span>
}
scanner.rescan = <span class="fstat-no" title="function not covered" >function(){</span>
<span class="cstat-no" title="statement not covered" >    return rescan();</span>
}
&nbsp;
/**
**********************************
...
&nbsp;
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if  (base === "index"){
<span class="cstat-no" title="statement not covered" >                    insertPathToIndex(relative,filePath);</span>
                }else{
...
function insertPathToIndex(alias, realpath){
    if (typeof filesInProject[alias] === 'string'){
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof ambiguousFileNames[alias] !== 'object') {
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 18 2017 09:01:58 GMT+0000 (UTC)</div>
</div>
</body>
</html>
